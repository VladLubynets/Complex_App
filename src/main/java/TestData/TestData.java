...
public class TestData {
    ...
    public final static String INVALID_LOGIN = ConfigProvider.configHiddenProperties.login5();
    public final static String INVALID_PASSWORD = ConfigProvider.configHiddenProperties.password5();

    public final static String INVALID_LOGIN_REVERSE = ConfigProvider.configHiddenProperties.login6();
    public final static String INVALID_PASSWORD_REVERSE = ConfigProvider.configHiddenProperties.password6();
}
