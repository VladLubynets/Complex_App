...
public class TestData {
    ...
    public final static String DELETE_USER = "User: Delete User DELETE api/user/{userid} Request Body { \"token\": \"your token\" }  Status code : 200 ResponseBody example { \"User with id {userId} was deletted \" } Status code : 403 ResponseBody example { \"Sorry, you must provide a valid token.\" } Status code : 400 ResponseBody example { \"Number of posts of this user is {numberOfPosts}. We can not delete user with posts.\" }";
