...
public class TestData {
   ...
   public final static String VALID_LOGIN_WITH_OLD_POSTS = System.getProperty("loginApiWithOldPosts", ConfigProvider.configHiddenProperties.login_with_old_posts());
    ...
    public final static String CREATE_ONE_POST = "Post: Create one POST POST /api/create-post Request Body { \"select1\": \"One Person\", \"title\": \"New post from API\", \"body\": \"post body\", \"token\": \"your token\" } NOTE: If you want to create a unique post for only followers you need to add to the body \"uniquePost\": \"yes\" - this field is optional - default value is \"no\" Status code : 200 ResponseBody example { \"Congrats.\" } Status code : 403 ResponseBody example { \"Sorry, you must provide a valid token.\" }";    public final static String DELETE_ONE_POST = "Post: Delete one POST DELETE /api/post/{postId} Request Body { \"token\": \"your token\" }  Status code : 200 ResponseBody example { \"Success\" } Status code : 403 ResponseBody example { \"Sorry, you must provide a valid token.\" }";
    ...
    public final static String VALID_LOGIN_FOR_DB = System.getProperty("loginForDB", ConfigProvider.configHiddenProperties.BD_Login());
    public final static String VALID_PASSWORD_FOR_DB = System.getProperty("passwordForDB", ConfigProvider.configHiddenProperties.BD_Password());
}
